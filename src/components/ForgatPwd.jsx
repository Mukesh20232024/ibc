            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-100">
                <div className="bg-white p-10 rounded shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className='mt-8'>
                        <div className="mb-4">
                            <input onChange={(e) => setEmail(e.target.value)} value={email} type="password" id="password" placeholder='Enter Email Address' className="w-full px-20 py-2 border border-gray-300 rounded" required />
                        </div>
